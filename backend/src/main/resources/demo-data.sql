...
(3, '地图地理编码API', 'API', '地址转经纬度和逆地理编码服务，覆盖全球，支持批量查询。', 'https://api.datahub.io/v1/api/geocoding', 59.90, 'ACTIVE', '地图,地理编码,LBS,API', '2026-03-10 10:00:00');

INSERT INTO subscriptions (subscriber_id, asset_id, quota_limit, quota_used, start_date, end_date, status, created_at) VALUES
(2, 1, 1000, 342, '2026-04-15', '2026-07-15', 'ACTIVE', '2026-04-15 09:00:00');
